...
import {extendTown,discretionaryVisits,addEconomy,planBusinesses,chooseShops,spendPlans,afterOperations} from '../web/economy.js';
...
for(let n=0;n<hours;n++){
  ...
  const opening=operatingBalances(t);processReturns(t);await chooseShops(t,core,judge);await discretionaryVisits(t,judge);core.applyConsequences(t);afterOperations(t,opening);finishOperations(t,opening);core.advanceWorld(t);await decideNews(t,core,judge);assertFinance(t);
